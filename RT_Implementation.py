...
def live_implementation(capture_source, save_path):
    capture = cv2.VideoCapture(capture_source)

    out = cv2.VideoWriter(save_path, cv2.VideoWriter_fourcc(*"MJPG"), 15, (512, 256))
...
if __name__ == '__main__':
    ...
    live_implementation('lanes_clip.mp4', 'camera_detection.avi')
